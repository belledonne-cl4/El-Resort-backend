  ...
  export const ReservationsBookService = {
    ...
    const adults = Array.isArray(adultsRaw)
      ...
      const reservationBody: JsonObject = {
        propertyID: asTrimmedString(rawBody.propertyID) ?? null,
        sourceID,
        thirdPartyIdentifier: asTrimmedString(rawBody.thirdPartyIdentifier) ?? null,
        startDate,
        endDate,
        guestFirstName,
        guestLastName,
        guestGender,
        guestCountry,
        guestZip: asTrimmedString(rawBody.guestZip) ?? null,
        guestEmail,
        ...
        promoCode: asTrimmedString(rawBody.promoCode) ?? null,
